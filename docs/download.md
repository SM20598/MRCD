# Download MRCD
Below you find the download links for the MRCD dataset. The downloads feature our ROS2 bags for each sequence, the according ground truth trajectory, and the survey-grade prior map of the campus environment. If any of the links is broken, a list of manuall downloads can be found [here](https://tore.tuhh.de/entities/product/db4dad9e-5c2d-451f-bd12-90dd0226cfd5).
